// models/SuspectLead.js

// const mongoose = require("mongoose");

// const SuspectLeadSchema = new mongoose.Schema(
//   {
...
// module.exports = mongoose.model("SuspectLead", SuspectLeadSchema);

// models/SuspectLeadModel.js
const mongoose = require("mongoose");
const LeadSchema = require("./LeadSchemaModel");

const SuspectLead = mongoose.model("SuspectLead", LeadSchema);
module.exports = SuspectLead;
